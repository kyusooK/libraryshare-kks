<template>
    <div>
        <BasePicker v-if="editMode" searchApiPath="books" searchParameterName=""  idField="bookId" nameField="bookId" path="books" label="BookId" v-model="value" @selected="pick" :editMode="editMode" />
